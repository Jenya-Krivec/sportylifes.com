...
@section('content')
    <form class="xl:px-20 sm:py-5 px-3 py-2 m-auto pt-24 sm:pt-24" action=" {{route('admin.storeBookmaker', $bookmaker['key'])}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex justify-between">
                <div class="hidden md:flex rounded-full">
                    <div class="w-28 cursor-pointer absolute top-1/2" style="transform: translateY(-50%);">
                        @if(!$bookmaker['logo'])
                        <label for="logo" class="w-full h-full flex justify-center items-center cursor-pointer bg-green-600 text-white rounded-md mx-2">Add logo</label>
                        @endif
                    ...
                    <div class="w-28 h-28 rounded-full my-auto mx-2 flex justify-center items-center cursor-pointer" id="logo-container" style="background-color: {{$bookmaker['logo_color']}}">
                        @if(!$bookmaker['logo_color'])
                            <label for="logo_color" class="absolute top-16 left-2 w-20 flex justify-center items-center cursor-pointer bg-green-600 text-white rounded-md">Add color</label>
                        @endif
        ...
        <div class="flex flex-row justify-center items-center m-2">
            <input type="submit" name="save" value="Save" class="h-10 bg-green-600 text-white px-4 rounded-full cursor-pointer transition-all duration-500 hover:bg-white hover:text-black border-2 border-green-600">
        </div>
    </form>
