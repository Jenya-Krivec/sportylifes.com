...
return [
    ...
    'paragraph3' => 'Al mismo tiempo, clasificamos a las casas de apuestas en diferentes categorías —por ejemplo, compañías nuevas u operadores que aceptan criptomonedas— para que resulte más fácil encontrar la opción adecuada.',
    'paragraph4' => 'El papel de nuestros expertos en la revisión',
    'paragraph5' => 'Nuestros expertos siguen un procedimiento riguroso al evaluar cada casa de apuestas. En las tres primeras etapas, verifican la fiabilidad de la empresa,
                    evalúan la calidad del producto y elaboran las reseñas según nuestra plantilla estándar. Sin embargo, su trabajo no se detiene ahí: cada 30 días,
    ...
    'paragraph11' => 'Dado que la industria está en constante evolución, es fundamental mantener actualizadas nuestras reseñas.
                    Nuestra participación regular en conferencias profesionales y el acceso a informes internos del sector son factores clave para ello.',
    'paragraph12' => 'Resolvemos las diferencias en las evaluaciones de las casas de apuestas entre nuestros evaluadores',
    'paragraph13' => 'Es completamente normal que las personas tengan opiniones diferentes sobre un mismo tema; sin embargo, nuestras reseñas se basan en datos objetivos, lo que ayuda a minimizar las discrepancias.
                    Los especialistas en verificación de hechos desempeñan un papel clave en este proceso.',
    'paragraph14' => 'Cuando surge una disputa, el experto en verificación realiza una serie de pruebas para asegurarse de que las preferencias personales no influyan en el contenido de las reseñas.',
    ];
