...
return [
    ...
    'paragraph3' => 'Parallèlement, nous classons les bookmakers par catégories —par exemple, les nouvelles sociétés ou les opérateurs acceptant les cryptomonnaies— afin de faciliter la recherche de l’option la plus adaptée.',
    'paragraph4' => 'Le rôle de nos experts dans l’évaluation',
    'paragraph5' => 'Nos experts suivent une procédure stricte lors de l’évaluation de chaque bookmaker. Lors des trois premières étapes, ils vérifient la fiabilité de l’entreprise,
                    évaluent la qualité du produit et rédigent les avis selon notre modèle standard. Cependant, leur travail ne s’arrête pas là :
                    tous les 30 jours, ils se reconnectent à leurs comptes et réévaluent chaque bookmaker afin de prendre en compte toutes les modifications des règles,
    ...
    'paragraph11' => 'Comme le secteur évolue constamment, il est essentiel de maintenir nos avis à jour.
                    Notre participation régulière à des conférences professionnelles et l’accès à des rapports internes du secteur sont des éléments cruciaux à cet égard.',
    'paragraph12' => 'Nous résolvons les divergences dans les évaluations des bookmakers entre nos évaluateurs',
    'paragraph13' => 'Il est tout à fait normal que les gens aient des opinions différentes sur une même question ; cependant, nos avis reposent sur des données objectives, ce qui permet de réduire au minimum les divergences.
                    Les spécialistes de la vérification des faits jouent un rôle clé dans ce processus.',
    'paragraph14' => 'Lorsqu’un désaccord survient, l’expert chargé de la vérification effectue une série de tests afin de s’assurer que les préférences personnelles n’influencent pas le contenu des avis.',
    ];
