...
class Comparison {
    ...
    add(id) {
        let row = '' +
            '<div class="relative">\n' +
            '    <div class="flex items-center text-white bg-green-600 rounded-full cursor-pointer transition-all duration-500 absolute -bottom-3 -left-4 hidden add-after" onclick="new AddSection().addComponent({target: this})" data-id="'+(id+1)+'" title="Add component after Сomparison">\n' +
        ...
        ['en', 'es', 'fr', 'pt'].forEach(lang => {
            ...
            '        <div class="flex justify-end items-center bg-green-600 w-full rounded-tr-xl rounded-tl-xl">\n' +
            ...
            '                <a href="" class="text-black text-xs link-for-review-2">. Review</a>\n' +
            '            </span>\n' +
            '            <span class="px-1 py-2 sm:p-2 w-28 flex-shrink-0 text-center">\n' +
            '                <a href="" class="text-black text-xs link-for-review-3">. Review</a>\n' +
            '            </span>\n' +
            '        </div>\n' +
            '        <div class="flex items-center justify-center self-center text-white bg-green-600 rounded-full h-6 w-6 transition-all duration-500 my-1 cursor-pointer add-row-comparison" onclick="new Comparison().addRow({target: this})" data-id="'+(id+1)+'" title="Add Row">+</div>\n' +
            '    </div>\n';
        });
        row += ' <select class="absolute top-1 -right-11 border-2 border-green-600 text-xs rounded language" onChange="new Language().toggle({target: this})" data-id="'+(id+1)+'" title="Change language for Сomparison">\n' +
