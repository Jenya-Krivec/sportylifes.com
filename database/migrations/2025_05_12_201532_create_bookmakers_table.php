...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('bookmakers', function (Blueprint $table) {
            ...
            $table->string('bonus_label_1_en', 250)->default('');
            $table->string('bonus_label_1_es', 250)->default('');
            $table->string('bonus_label_1_fr', 250)->default('');
            $table->string('bonus_label_1_pt', 250)->default('');
            $table->string('bonus_label_2_en', 250)->default('');
            $table->string('bonus_label_2_es', 250)->default('');
            $table->string('bonus_label_2_fr', 250)->default('');
            $table->string('bonus_label_2_pt', 250)->default('');
